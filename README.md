...
| 03 | **Megha Ramthirth** | Extended Admin Dashboard (Add/Delete/Promote/Demote/Unlock Users) · Route AI & Maritime Fuel Efficiency · Dynamic Freight Pricing · Carrier Performance & Capacity Intelligence · Weather Risk & Storm Telemetry |
...
▶️ See [`docs/demo/demo.mp4`](docs/demo/demo.mp4) for the full demo recording.
